# Project EVOLVE v0.3.3


## v0.3.3 hotfix

- Fixed Java compilation failure in `MonsterCameraController`.
- Removed obsolete `InvocationTargetException` catch from the ProtocolLib camera packet send path.
- Kept the Monster TPS camera, visible Monster body, wall collision, combat, wildlife, feeding, and evolution behavior from v0.3.2 unchanged.
